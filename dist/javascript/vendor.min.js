...
System.register('javascript/main', ['./api', './display-images', './page-loader'], function (_export, _context) {
  var API, DisplayImages, PageLoader, TAGS, callback, URL_PATH, imageContainer, pageActions;
  ...
  return {
    ...
    execute: function () {
      ...
      pageActions = [{ page: 'index', callback: urlRequest }, { page: 'saved', callback: 'dataHandler.renderSaved' }];
