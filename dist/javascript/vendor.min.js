...
System.register('javascript/main', ['./api', './display-images', './page-loader'], function (_export, _context) {
  var API, DisplayImages, PageLoader, TAGS, callback, URL_PATH, displayImages, pageCallbacks;
  return {
    ...
    execute: function () {
      ...
      pageCallbacks = [{ page: 'index', callback: displayImages.renderDefault }, { page: 'saved', callback: displayImages.renderSaved }];
...
System.register('javascript/page-loader', [], function (_export, _context) {
  var _createClass, DEFAULT_NAV, PageLoader;
      ...
      PageLoader = function () {
        ...
        _createClass(PageLoader, [{
          ...
          value: function loadPage(page) {
            for (var i = 0, pageCallbacksLength = this.pageCallbacks.length; i < this.pageCallbacksLength; i++) {
