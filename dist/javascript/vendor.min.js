      ...
      DisplayImages = function () {
        ...
        _createClass(DisplayImages, [{
          ...
          value: function renderAsset(asset) {
            var imageCardClass = 'mdl-cell mdl-cell--4-col mdl-card mdl-shadow--2dp';
...
System.register('javascript/main', ['./api', './display-images'], function (_export, _context) {
  var API, DisplayImages, TAGS, callback, URL, api;
  return {
    ...
    execute: function () {
      ...
      URL = 'http://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=' + callback + '&tags=' + TAGS;
      api = new API(URL, callback, DisplayImages);
    }
  };
});
